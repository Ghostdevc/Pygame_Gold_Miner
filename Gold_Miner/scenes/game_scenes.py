...
class FailureScene(object):
    ...
    def render(self, screen):
        ...
        screen.blit(panel_image, panel_image.get_rect(center=(screen_width / 2, screen_height / 2)))
        screen.blit(text_game_image, text_game_image.get_rect(center=(screen_width / 2, 200)))
        text = 'Gerekli puana ulaşmadınız!\nTekrar oynamak için Space tuşuna basın'
...
class WinScene(object):
    ...
    def render(self, screen):
        ...
        screen.blit(panel_image, panel_image.get_rect(center=(screen_width / 2, screen_height / 2)))
        screen.blit(text_game_image, text_game_image.get_rect(center=(screen_width / 2, 200)))
        text = 'Bu oyunu kazandığınız için tebrikler\n!\n\nTekrar oynamak için Space tuşuna basın'
...
class StoreScene(object):
    def __init__(self):
        ...
        self.text = 'Satın almak istediğiniz öğeye tıklayın\nHazır olduğunuzda devam et e tıklayın'
        self.is_buy = False
...
class GameScene(Scene):
    ...
    def update(self, screen):
        ...
        screen.blit(self.text_font.render("Zaman:", True, (0, 0, 0)), (1140, 0))
        screen.blit(self.text_font.render(str(self.timer), True, (255, 100, 7)), (1240, 0))
        screen.blit(self.text_font.render("Hibe etmek:", True, (0, 0, 0)), (1140, 25))
